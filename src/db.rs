...
impl JiraDatabase {
    ...
    pub fn create_story(
        ...
        parsed
            ...
            .get_mut(&epic_id)
            .ok_or_else(|| {
                anyhow!("could not find epic in database!")
            })?
            .stories
            .push(new_id);
    ...
    pub fn update_story_status(
        ...
        parsed
            ...
            .get_mut(&story_id)
            .ok_or_else(|| {
                anyhow!("Could not find story in database!")
            })?
            .status = status;
...
pub mod test_utils {
    ...
    impl Database for MockDB {
        fn read_db(&self) -> Result<DBState> {
            let state =
                self.last_written_state.borrow().clone();
            Ok(state)
        }
...
mod tests {
    ...
    fn create_epic_should_work() {
        ...
        // TODO: fix this error by deriving the
        // appropriate traits for Epic
    ...
    fn create_story_should_error_if_invalid_epic_id() {
        ...
        let result =
            db.create_story(story, non_existent_epic_id);
    ...
    fn create_story_should_work() {
        ...
        // TODO: fix this error by deriving the
        // appropriate traits for Story
        let result =
            db.create_story(story.clone(), epic_id);
        assert_eq!(result.is_ok(), true);
    ...
    fn delete_story_should_error_if_invalid_epic_id() {
        ...
        let result =
            db.delete_story(non_existent_epic_id, story_id);
        assert_eq!(result.is_err(), true);
    }
    ...
    fn delete_story_should_error_if_story_not_found_in_epic(
        ...
        let result =
            db.delete_story(epic_id, non_existent_story_id);
        assert_eq!(result.is_err(), true);
    }
    ...
    fn update_epic_status_should_error_if_invalid_epic_id()
    {
        ...
        let result = db.update_epic_status(
    ...
    fn update_epic_status_should_work() {
        ...
        let result =
            db.update_epic_status(epic_id, Status::Closed);
    ...
    fn update_story_status_should_error_if_invalid_story_id(
        ...
        let result = db.update_story_status(
