...
use crate::{
    ...
    models::Action,
    ui::{
        EpicDetail, HomePage, Page, Prompts, StoryDetail,
    },
};
...
impl Navigator {
    ...
    pub fn get_current_page(
        ...
        // this should always return the last element in
        // the pages vector
        todo!()
    }
...
mod tests {
    ...
    fn handle_action_should_navigate_pages() {
        ...
        let current_page = nav.get_current_page().unwrap();
        let epic_detail_page = current_page
            .as_any()
        ...
        let current_page = nav.get_current_page().unwrap();
        let story_detail_page = current_page
            .as_any()
    ...
    fn handle_action_should_handle_create_epic() {
        ...
        let epic =
            db_state.epics.into_iter().next().unwrap().1;
    ...
    fn handle_action_should_handle_update_epic() {
        ...
        let mut prompts = Prompts::new();
        prompts.update_status =
            Box::new(|| Some(Status::InProgress));
    ...
    fn handle_action_should_handle_create_story() {
        ...
        let story =
            db_state.stories.into_iter().next().unwrap().1;
